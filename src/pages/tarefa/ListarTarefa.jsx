            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="right" style={row.statusTarefa === 'Concluída'? { color: 'green', fontWeight: 900}: row.statusTarefa === 'Aguardando'? { color: '#e9760a', fontWeight: 900} : {}} >{row.statusTarefa}</TableCell>
